@echo off
setlocal
title All-in-one Intel-safe Tweaks

:: ============================================================
::  All-in-one (Intel-safe) launcher.
...
::            Network\Optional, Latency\CPU\all_proc_for_PBO.ps1 (AMD PBO only).
:: ============================================================
...
echo ============================================================
echo  Running Intel-safe tweaks. Each file runs in its own window-less
...
call :run "Latency\System\MultimediaPrio.reg"
...
call :run "Latency\System\DwmTuner.ps1"

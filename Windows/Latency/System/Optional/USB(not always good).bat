...
REM wmic is removed in Win11 24H2/25H2 and its FoD disappears in the next feature update - use CIM
FOR /F %%a in ('powershell -NoProfile -Command "(Get-CimInstance Win32_USBHub).DeviceID" ^| FINDSTR /L "VID_"') DO (
